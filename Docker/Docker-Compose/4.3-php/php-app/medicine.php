                ...
                <div class="wrapper">
                    <div class="column">
                        <div class="sectop flexitem">
                            <h2 style="text-align: center;"><span class="circle" style="text-align: center;"></span><span>Medicine</span></h2>
                        </div>
                        <div class="products main flexwrap">
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    ...
                                    <p style="font-weight: 5px; color:rgb(59, 58, 58); font-size: 12px;"><i><?php echo $fetch_products['gname']; ?></i></p>
                                    <div class="rrr">
                                        <div class="price">
