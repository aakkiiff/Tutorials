                ...
                <div class="wrapper">
                    <div class="column">
                        <div class="sectop flexitem">
                            <h2 style="text-align: center;"><span class="circle" style="text-align: center;"></span><span>Supplements & Vitamins</span></h2>
                        </div>
                        <div class="products main flexwrap">
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    <h3 class="main-links"><a href="#"><?php echo $fetch_vitamins['name']; ?></a></h3>
                                    <div class="rrr">
                                        <div class="price">
                                            <span class="current"><?php echo $fetch_vitamins['oprice']; ?> TAKA</span>
                                            <span class="normal mini-text"><?php echo $fetch_vitamins['price']; ?> TAKA</span>
                                        </div>
                                    </div>
                                    <div class="quintity" style="display:flex;">
                                        <input type="hidden" name="product_name" value="<?php echo $fetch_vitamins['name']; ?>">
                                        <input type="hidden" name="product_price" value="<?php echo $fetch_vitamins['oprice']; ?>">
                                        <input type="hidden" name="product_image" value="<?php echo $fetch_vitamins['image']; ?>">    
