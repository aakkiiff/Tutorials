                ...
                <div class="wrapper">
                    <div class="column">
                        <div class="sectop flexitem">
                            <h2 style="text-align: center;"><span class="circle" style="text-align: center;"></span><span>Sexual Wellness</span></h2>
                        </div>
                        <div class="products main flexwrap">
                            ...
                            <div class="item">
                                ...
                                <div class="content">
                                    <h3 class="main-links"><a href="#"><?php echo $fetch_sexual['name']; ?></a></h3>
                                    <div class="rrr">
                                        <div class="price">
                                            <span class="current"><?php echo $fetch_sexual['oprice']; ?> TAKA</span>
                                            <span class="normal mini-text"><?php echo $fetch_sexual['price']; ?> TAKA</span>
                                        </div>
                                    </div>
                                    <div class="quintity" style="display:flex;">
                                        <input type="hidden" name="product_name" value="<?php echo $fetch_sexual['name']; ?>">
                                        <input type="hidden" name="product_price" value="<?php echo $fetch_sexual['oprice']; ?>">
                                        <input type="hidden" name="product_image" value="<?php echo $fetch_sexual['image']; ?>">    
